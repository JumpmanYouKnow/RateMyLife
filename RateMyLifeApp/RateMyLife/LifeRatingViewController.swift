...
class LifeRatingViewController : UIViewController{
    ...
    lazy var logoImage: UIImageView! = {
        ...
        imageView.image = UIImage(named: "RateMyLife")
    ...
    func initScoreView(){
        ...
        circleSlider = CircleSlider(frame: CGRect(x: self.view.frame.width / 2 - 185, y: -50, width: 370, height: 370) , options: [.barColor(UIColor.white),
                                                                                                                                   .trackingColor(UIColor(red: 18/255, green: 230/255, blue: 3/255, alpha: 1)),
                                                                                                                                   .barWidth(35),
                                                                                                                                   .sliderEnabled(false)])
    ...
    func valueChange(sender: CircleSlider) {
        ...
        attributedString.setAttributes([NSFontAttributeName : UIFont(name: "Teen-Bold", size: 70)!,NSForegroundColorAttributeName : AppColor.progressLabel], range: stringTwoRange)
